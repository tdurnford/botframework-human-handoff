...
- Connect to User
  - Navigate to [http://localhost:3978/](http://localhost:3978/). Message `#list` to get a list of users waiting to talk to an agent in the queue, and message `#connect` to connect to the user waiting at the top of the queue.
